...
public final class ItemFileBinding implements ViewBinding {
  ...
  private ItemFileBinding(@NonNull MaterialCardView rootView, @NonNull ImageView ivFileIcon,
      @NonNull TextView tvFileExtension, @NonNull TextView tvFileName,
  ...
  public static ItemFileBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemFileBinding((MaterialCardView) rootView, ivFileIcon, tvFileExtension,
